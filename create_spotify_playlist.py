...
This script provides a command line interface for creating Spotify playlists
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description="Create a Spotify playlist from music sources")
...
async def main():
    ...
    logger.info("Using Spotify as destination")
    ...
    if not authenticated:
        ...
        logger.error("Please run 'python token_exchange.py YOUR_AUTH_CODE' first")
        return 1
